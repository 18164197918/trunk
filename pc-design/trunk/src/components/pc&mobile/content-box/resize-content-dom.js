import $ from 'jquery'
import { dataEdit, dataCache, dataMethods, constant, constantDom } from '../common'

const {parseFloor,}                                                                                                      = constant
const {RESIZABLE_HANDLE, BODY_RESIZING_MODULE, USER_MODULE, COMMON_RESIZING_MODULE, MODULE_CONTAINER_NAME, $DOC, $BODY,} = constantDom
const {resizeRelativePositionVertical}                                                                                   = dataMethods
