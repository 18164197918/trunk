      ...
      fullPosition(index) {
        ...
        switch (index) {
          ...
          case 4:   //下对齐
            ...
            if (match[2] === 'px') {
              this.css.top = CALC + '(100% - ' + parseFloor(match[1]) + 'px)'
            }
            else if (match[2] === '%') {
              this.css.top = parseFloor(100 - match[1]) + '%'
          ...
          case 6:   //水平居中
            ...
            if (match[2] === 'px') {
              ...
              this.css.left = parseFloor(50 - match[1] / 2) + '%'
            }
            this.$delete(this.css, 'right')
            break
          ...
          case 7:   //右对齐
            ...
            if (match[2] === 'px') {
              ...
              this.css.left = parseFloor(100 - match[1]) + '%'
            }
            break
