import $ from 'jquery'
import { dataCache, dataSite, dataPage, dataEdit, dataMethods, constant, constantDom } from './index'

const {createModule, addModule}              = dataMethods
const {UNIT_REG, toString, $fp, convertUnit} = constant
const {
