...
import moduleListBase from '../module-tpl-box/adv/list/base'
import moduleGroupList from '../module-tpl-box/adv/group/list'
import {
  toString,
  MODULE_ASSIST_MAP,
...
export const listToGroup = function () {
  ...
  info = $.extend(true, {}, moduleGroupList[0].info, groupModuleAssist)
