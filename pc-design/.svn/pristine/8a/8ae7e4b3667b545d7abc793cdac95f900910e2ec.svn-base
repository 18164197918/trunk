<template>
    <div :class="[info.static.class, {'edit-sub-module': info.assist && info.assist.m===1}]" class="pc-module-menu mobile-module-menu user-module">


        <div class="ul level1 inner-menu">

          <div class="menu-btn" @click="showMenu">菜单按钮</div>
...
<style lang="scss">
  .pc-module-menu.mobile-module-menu{
    transition:all .4s;
    width:0;
...
<script>
  ...
  export default {
    ...
    methods   : {
      showMenu(){
        $(document).find('.pc-module-menu.mobile-module-menu').toggleClass('active')
      },
