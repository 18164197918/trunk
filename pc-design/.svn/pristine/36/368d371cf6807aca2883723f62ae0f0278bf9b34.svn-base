  ...
  <div class="wrapper design-module-wrapper pc-category-box">
    <div class="right">
      <div class="category-tree-box">
        <div class="d-flex">
          <h3>拓扑图</h3>
          <router-link target="_blank" to="/category/column/manager" class="text-primary c-pointer ml15">
      ...
      <div class="module-box">
        <div class="module-tit d-flex align-center justify-between mb20">
          ...
          <span v-if="!isEditing"><span @click="editCategory(true)" title="模板与栏目绑定" class="iconfont iconfont-bangding mr5"></span>栏目绑定</span>
...
<script>
  ...
  import { createModule, clearConfigAssist } from '../common/data-methods'
              ...
              if (this.categoryListEqualObj[ids[i]].archive_num) {
                ...
                if (page_type === 'CONTENT_PAGE') {
                  ...
                  for (let i = 0, len = allContentList.length; i < len; ++i) {
                    //console.log(allContentList[i].category_index)
