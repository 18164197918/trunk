<template>
    <div class="contmodel">
        <h6 class="app-title">栏目管理</h6>

        <div class="app-block-lv2 df justify-start">
          <el-button type="primary-com" @click="addColumn(1)">新建</el-button>
          <p class="text-gray lh36 ml10"><i class="text-danger el-icon-warning mr5"></i>新建按钮只能新建一级栏目</p>
        </div>
