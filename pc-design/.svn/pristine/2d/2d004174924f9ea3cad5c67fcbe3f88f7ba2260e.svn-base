<template>
    <div>
        ...
        <div v-else>
            <base-module-data v-if="assist.a===0" :first="first" :key="info.className"></base-module-data>
            <base-module-font :css="innerObj" :notAllow="['fontSize', 'color', 'fontWeight', 'fontStyle', 'textDecoration', 'justifyContent']"></base-module-font>
