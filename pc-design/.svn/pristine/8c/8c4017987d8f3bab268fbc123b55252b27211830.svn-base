<template>
    <div class="content-tag contmodel pt20 pr40 pb30 pl30"  style="border-top-left-radius: 4px;">
        <div class="common-tit2">
            <h4><b>标签管理</b><span class="fz12 ml20 tips"><i class="iconfont iconfont-warning mr3 mt3"></i>最多可添加24条标签</span></h4>
        </div>
        <div class="d-flex justify-start bg-gray-l64 pt20 pb20 mb30 pr20 pl20 tb-upper">
            <div id="btns">
                <el-button type="success" class="btn-primary" @click="addSwitch = true">新建</el-button>
