<template>
    <div class="creatmodel pt20 pr40 pb30 pl30" style="border-top-left-radius: 4px;">
        <!--客户信息头部-->
        <div>
            <div class="common-tit2">
                <h4><b>栏目模型</b><span class="fz12 ml20 tips"><i class="iconfont iconfont-warning mr3 mt3"></i>左侧创建成功的栏目模型将会显示在栏目管理的新建栏目</span></h4>
            </div>
        </div>
        <!--客户信息内容-->
        <div class="operate">
