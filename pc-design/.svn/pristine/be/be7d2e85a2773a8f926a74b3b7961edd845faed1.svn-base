import $ from 'jquery'
import { dataCache, constantDom } from '../../pc&mobile/common'

const {$DOC, $BODY, LEFT_BOX, PANNEL_BTN, DESIGN_TERMINAL, LEFT_MENU_ICON, RIGHT_BOX, CONTENT_BOX, BODY_MOVING_MENU, WRAPPER_BTN, DESIGN_MODULE_WRAPPER,} = constantDom
