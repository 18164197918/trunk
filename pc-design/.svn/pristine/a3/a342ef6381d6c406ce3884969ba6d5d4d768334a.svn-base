    ...
    <div class="creatmodel">
        ...
        <div>
            <div class="common-tit2">
                <h4>内容模型<b> - 修改模型字段</b><span class="fz12 ml20 tips"><i class="iconfont iconfont-warning mr3 mt3"></i>左侧创建成功的内容模型将会显示在内容管理的新建页面</span></h4>
            </div>
        </div>
        <!--客户信息内容-->
                <div class="d-flex">
                    <div class="left pr20">
                        <el-table :data="tableData" class="fz14">
                            <el-table-column
                                    label="字段名称"
                                    width="240"
                                    class="pl15">
