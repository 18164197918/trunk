...
<template>
  <div class="myPickup">
    <delivery :name="'pickup'"></delivery>
    <el-row class="bb-gray h40 mt10">
      <el-col class="w100">到店自提</el-col>
      <el-col :span="20">
        <el-switch
          active-color="#34cd96"
          active-text="已开启"
    ...
    >
      ...
      <el-form-item label="设置为默认配送方式：">
        ...
        ></el-switch>
        <span class="fz12 text-gray-l20 ml20">买家下单时，默认[到店自提]作为默认配送方式</span>
      </el-form-item>
        ...
        >
          <el-radio-group v-model="form.auto_stock_mode">
            ...
            >
              ...
              ></el-input>
              <span class="ml5 mr5">天后，买家可提货</span>
            </el-radio>
            <el-radio
  ...
  data () {
    return {
      ...
      form: {
        ...
        'pickup_period': '',
        'able_pickup_expired': true, // 提货有效期
        'pickup_expired': 10, // 提货有效期天数
        'expired_order_handle_type': 'ORDER_COMPLETE_NO_REFUND', // 提货有效期天数
        'able_pickup': true, // 总开关
        'default_delivery': true, // 设置为默认配送方式
        'auto_stock': true, // 系统自动完成备货
