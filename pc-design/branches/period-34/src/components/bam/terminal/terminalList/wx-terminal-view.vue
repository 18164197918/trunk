    ...
    <div class="make-sure-fail">
      ...
      >
        <div class="make-sure-upate-inner">
          <div class="make-sure-upate-title text-center">
            <span class="iconfont iconfont-warning text-danger"></span>
            <em class="pl6 text-gray-d30">{{msg.str}}</em>
          </div>
          <div class="make-sure-upate-btn pt42 mb15 text-center">
            <el-button
              @click="cancelFail"
...
export default {
  ...
  mounted () {
    ...
    if (href.indexOf('bam/terminal/chooseList/wx?error') > -1) {
      this.msg.str = decodeURIComponent(href.split('error=')[1])
      this.msg.show = true
    }
    // 请求最新模板
