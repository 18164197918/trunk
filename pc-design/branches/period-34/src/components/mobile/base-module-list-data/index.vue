<template>
  <div :class="{'show-set-box': isShowSetBox}" class="base-block">
    ...
    <div class="base-set-box">
      ...
      <div>
        <sortList v-if="_static.dataOrigin===0" :options="{data: _static.dataList, axis: 'y',cancel:'.iconfont-delete,.iconfont-copy', placeholder: 'static-data-place-holder'}" class="list-static-data-box">
