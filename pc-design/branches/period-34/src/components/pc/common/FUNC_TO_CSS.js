...
let i, l, className, classNames, css, hoverCss, groupHoverCss, propVal, name, str,
    urlPrefix = 'url(' + config.fileManagerPrefix,
    $reg      = /\${3}/,
    camelReg  = /([A-Z])/g,
    lgReg     = /linear-gradient|radial-gradient/

function transferCssHead(obj) {
  let className       = obj.className,
      originalClass   = obj.originalClass,
      isHover         = obj.isHover || false,
      isGroupHover    = obj.isGroupHover || false,
      mode            = obj.mode,
      fatherClassName = obj.fatherClassName
